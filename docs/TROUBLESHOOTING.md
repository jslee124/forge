...
Forge never converts one into the other. See [Authentication](AUTHENTICATION.md).
...
retain private/reserved-address checks. See the [example README](../examples/plugins/web-tools/README.md).
