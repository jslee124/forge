...
> boundaries. This is not fresh verification of the current checkout; source and
> tests define current behavior.
...
[v0.3.3 implementation record](../v0.3.3/LONG_SESSION_IMPLEMENTATION.md).
...
Plan](../v0.3.3/STRUCTURED_SESSION_HISTORY.md).
...
[v0.3.4 implementation plan](IMPLEMENTATION_PLAN.md).
