...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/source-v0.3.0-bootstrap.0-0e7490?style=flat-square" alt="源码版本 0.3.0-bootstrap.0">
...
Forge 仍在积极开发中。当前源码和 npm release 目标版本是 `0.3.0-bootstrap.0`。自动上下文 checkpoint 仍默认 opt-in，同时还在收集 provider 质量证据。
