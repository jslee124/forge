...
| `CI=true pnpm check:docs` | Passed; 100 Markdown files and 432 local references |
| `CI=true pnpm test` | Passed; 56 files and 350 tests |
| `CI=true pnpm eval:deterministic` | Passed; 12 files and 69 tests |
| `CI=true pnpm package:verify` | Passed; clean installed package size 331,604 bytes |
